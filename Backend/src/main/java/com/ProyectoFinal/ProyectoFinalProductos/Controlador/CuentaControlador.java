...
import com.ProyectoFinal.ProyectoFinalProductos.Modelos.RegistroDto;
...
public class CuentaControlador {
    ...
    public ResponseEntity<?> registrar(@RequestBody RegistroDto registroDto) {
        ...
        try {
            ...
            newUser.setDni(registroDto.getDni()); // ← SOLO ESTA LÍNEA AGREGADA
            ...
            if (ex.getMessage().contains("Duplicate entry") && ex.getMessage().contains("dni")) {
                response.put("message", "DNI ya registrado");
            } else {
